...
The application has all the main points required, as well as user authentication with Devise, small style changes on the main page, and unit tests.
...
1. To access the application login with user generated by seed:
```
email: admin@admin
password: 123456
```
2. Put the *cnab.txt* file found in the project's root folder or some other in the same structure and send.
3. All data will be processed and displayed on screen.

## Pending Changes
1. Put stylesheet on Devise screens
2. Make other actions available to make a complete CRUD
---
